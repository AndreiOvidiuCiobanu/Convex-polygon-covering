...
function deseneaza_poligon(){
	...
	ctx.beginPath();  
	ctx.moveTo(puncte[0].x,puncte[0].y);        //am pus alerturi ca sa vad ce eroare are si cumva nu intra deloc in for..
												//legat de sintaxa cu fill sunt ff multe variante pe net, eu am incercat cam tot si nu am reusit nimic
	for(i=1; i<n; i++)
	{
